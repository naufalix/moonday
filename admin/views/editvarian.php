            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor"><i class="fa fa-edit"></i> Edit Varian</h4>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card" style="border:1px solid darkgray;">
                            <div class="card-body">
                                ...
                                <h2 class="card-title" style="padding:50px 0px 10px 50px; color:steelblue;">Form Edit Varian</h2>
                                <br>

                                <!--form-->
                                <form action="konfirmasieditvarian.php" method="post" class="form-horizontal form-material">
                                    ...
                                    <h4 class="col-md-3">Nama Varian</h4>
                                        <div class="col-md-8" style="border:1px solid dimgray;">
                                            <input type="text" name="varian" value="Coffee"
