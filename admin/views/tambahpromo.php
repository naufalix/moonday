            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor"><i class="fa fa-plus-circle"></i> Tambah Promo</h4>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card" style="border:1px solid darkgray;">
                            <div class="card-body">
                                ...
                                <h2 class="card-title" style="padding:50px 0px 10px 50px; color:steelblue;">Form Tambah Promo</h2>
                                <br>

                                <!--form-->
                                <form action="konfirmasitambahpromo.php" method="post" class="form-horizontal form-material">
                                    ...
                                    <h4 class="col-md-3">Nama</h4>
                                        <div class="col-md-8" style="border:1px solid dimgray;">
                                            <input type="text" placeholder="Nama Promo" name="nama"
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-11">
                                            <button class="btn btn-danger float-right" style="margin-bottom:50px;"type="submit" name="tambahpromo" 
                                            value="tambahpromo"><i class="fa fa-plus-circle"></i> Tambah Promo</button></a>
                                    </div>
                                </form>
                            </div>
                        </div>
